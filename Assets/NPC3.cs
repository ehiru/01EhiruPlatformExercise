    ...
    public void OnOptionSelected(int optionIndex)
{
    ...
    private void ApplyDialogueChoice(int optionIndex)
    {
        if (optionIndex == 0)
        {
            ...
            {
                new LocalizedString { TableReference = "SecondDialogues", TableEntryReference = "sick" },
                new LocalizedString { TableReference = "SecondDialogues", TableEntryReference = "afraid" },
                new LocalizedString { TableReference = "SecondDialogues", TableEntryReference = "quit" }
        ...
        else if (optionIndex == 1)
        {
            dialogues = new LocalizedString[]
            {
                new LocalizedString { TableReference = "SecondDialogues", TableEntryReference = "hang" },
                new LocalizedString { TableReference = "SecondDialogues", TableEntryReference = "better" },
                new LocalizedString { TableReference = "SecondDialogues", TableEntryReference = "support" }
