    ...
    public void OnOptionSelected(int optionIndex)
{
    ...
    private void ApplyDialogueChoice(int optionIndex)
    {
        if (optionIndex == 0)
        {
            ...
            {
                new LocalizedString { TableReference = "ThirdDialogues", TableEntryReference = "value" },
        ...
        else if (optionIndex == 1)
        {
            dialogues = new LocalizedString[]
            {
                new LocalizedString { TableReference = "ThirdDialogues", TableEntryReference = "leisure" },
